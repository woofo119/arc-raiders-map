...
export const SKILL_DATA = {
    ...
    mobility: {
        ...
        skills: [
            ...
            // Sub-branch A (Ankles/Walk)
            { id: "m11", name: "튼튼한 발목", maxLevel: 5, description: "치명적이지 않은 높이에서 떨어질 때 받는 낙상 피해가 줄어듭니다.", reqPoints: 0, x: 54, y: 55, icon: skillIcons.m11, prerequisites: ["m13"] },
            { id: "m1", name: "차분한 산보", maxLevel: 1, description: "걸을 때도 가만히 서 있을 때처럼 기력이 회복됩니다. 기본 이동이 아니라 V를 누르고 걸을 때의 회복량이 늘어난다.", reqPoints: 15, x: 54, y: 45, icon: skillIcons.m1, prerequisites: ["m11"] },
            { id: "m_new2", name: "혈기 왕성 뜀박질", maxLevel: 1, description: "기력 소진 상태에서 더는 뛰어넘기 속도가 느려지지 않습니다.", reqPoints: 0, x: 54, y: 35, icon: skillIcons.m12, prerequisites: ["m1"] },

            // Sub-branch B (Wall/Vault) - Attached to m13
            { id: "m5", name: "미친 듯 벽 타기", maxLevel: 5, description: "더 멀리 벽 도약을 시전할 수 있습니다. 도약 거리가 약 10% 증가한다.", reqPoints: 0, x: 62, y: 55, icon: skillIcons.m5, prerequisites: ["m13"] },
            { id: "m_new1", name: "구를 준비 완료", maxLevel: 5, description: "낙하 시, 낙법을 시전할 수 있는 타이밍이 길어집니다.", reqPoints: 0, x: 62, y: 45, icon: skillIcons.m6, prerequisites: ["m5"] },
            { id: "m14", name: "걷기 전에 기기", maxLevel: 5, description: "쓰러졌을 때 기어가는 속도가 빨라집니다. 기어가는 속도가 최대 35% 증가한다.", reqPoints: 0, x: 62, y: 35, icon: skillIcons.m14, prerequisites: ["m_new1"] },
            { id: "m16", name: "넘고 넘고 뛰어넘고", maxLevel: 1, description: "뛰어넘기가 더는 기력을 소모하지 않습니다.", reqPoints: 36, x: 62, y: 25, icon: skillIcons.m16, prerequisites: ["m14"] }
        ]
    },
    survival: {
        label: "생존",
