...
export const SKILL_DATA = {
    ...
    mobility: {
        ...
        skills: [
            ...
            { id: "m15", name: "추진력을 얻기 위함", maxLevel: 1, description: "전력 질주 회피 구르기 후, 잠깐 전력 질주가 기력을 소모하지 않습니다. 쿨다운 시간이 적용됩니다. 약 2초간 기력을 소모하지 않는다. 쿨은 약 15초.", reqPoints: 15, x: 55, y: 15, icon: skillIcons.m15, prerequisites: ["m6", "m3"] },
