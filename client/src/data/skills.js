...
export const SKILL_DATA = {
    conditioning: {
        ...
        skills: [
            ...
            { id: "c15", name: "위기 극복", maxLevel: 1, description: "치명상 상태 시, 체력을 특정 한도까지 자동으로 회복합니다.", reqPoints: 36, x: 20, y: 15, icon: skillIcons.c15, prerequisites: ["c13", "c11"] }
        ]
    },
    mobility: {
        label: "이동성",
        ...
        skills: [
            ...
            { id: "m7", name: "힘들이지 않고 구르기", maxLevel: 5, description: "회피 구르기로 소모하는 기력이 줄어듭니다. 3레벨에서 기력 감소가 최소가 되며, 구르기 횟수가 추가된다.", reqPoints: 0, x: 45, y: 35, icon: skillIcons.m7, prerequisites: ["m9"] },
            ...
            { id: "m15", name: "연속 뛰기", maxLevel: 1, description: "뛰어넘기가 끝나기 직전에 점프할 수 있습니다.", reqPoints: 36, x: 55, y: 15, icon: skillIcons.m15, prerequisites: ["m6", "m3"] },
            { id: "m16", name: "넘고 넘고 뛰어넘고", maxLevel: 1, description: "뛰어넘기가 더는 기력을 소모하지 않습니다.", reqPoints: 36, x: 45, y: 15, icon: skillIcons.m16, prerequisites: ["m10", "m3"] }
        ]
    },
    survival: {
        label: "생존",
