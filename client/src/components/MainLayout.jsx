...
const MainLayout = () => {
    ...
    return (
        <div className="flex h-screen w-screen bg-black text-white overflow-hidden font-sans selection:bg-arc-accent selection:text-white">
            {/* Mobile Header / Toggle - Hide on Map Page if we want full immersion, strictly user asked for left nav things to move */}
            {/* Let's keep mobile header logic consistent or hide it too? Usually map has own controls. 
                For now, we'll hide the global sidebar logic which is mainly Desktop 'lg:flex'. 
                The mobile header is 'lg:hidden', let's leave it for now unless requested. 
            */}
