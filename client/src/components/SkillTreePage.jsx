...
const SkillTreePage = () => {
    ...
    const lines = [
        ...
        // Mobility (Center x=50, Left x=42, Right x=58)
        // Root m3 (50, 75) branches to m5 (50, 65), m4 (42, 65), m13 (58, 65)
        { x1: 50.0, y1: 72.48, x2: 50.0, y2: 66.68 }, // m3 -> m5
        { x1: 48.74, y1: 72.48, x2: 43.26, y2: 66.68 }, // m3 -> m4
        { x1: 51.26, y1: 72.48, x2: 56.74, y2: 66.68 }, // m3 -> m13

        // Center Column
        { x1: 50.0, y1: 63.13, x2: 50.0, y2: 56.88 }, // m5 -> m_new1
        { x1: 50.0, y1: 53.13, x2: 50.0, y2: 36.88 }, // m_new1 -> m14 (Long gap 55->35?) No, m14 is at 35. gap 20 units? Visual line needs to span.
        { x1: 50.0, y1: 33.13, x2: 50.0, y2: 17.81 }, // m14 -> m16
        ...
        // Right Column
        { x1: 58.0, y1: 63.13, x2: 58.0, y2: 56.88 }, // m13 -> m11
        { x1: 58.0, y1: 53.13, x2: 58.0, y2: 47.81 }, // m11 -> m1
        { x1: 58.0, y1: 42.19, x2: 58.0, y2: 36.88 }, // m1 -> m_new2
