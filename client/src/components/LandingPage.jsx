...
const LandingPage = () => {
    ...
    // Increased multiplier for "shoot up" effect
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden relative font-sans">
            ...
            <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden flex justify-center items-center">
                <div
                    ...
                    style={{
                        ...
                        width: '150vw',
                        height: '300vh' // Taller to accommodate fast scrolling
                    }}
                >
            ...
            {/* Header / Nav - Fixed at top, transparent */}
                        ...
                        {[
                            {
                                ...
                                image: "https://rs.nxfs.nexon.com/game/arcraiders/common/img_news_41.jpg"
                            },
                            {
                                id: 39,
