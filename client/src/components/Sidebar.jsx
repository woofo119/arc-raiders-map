...
const Sidebar = ({ isOpen = false }) => {
    ...
    return (
        <div className={`absolute left-0 top-0 h-full w-72 bg-[#121212] border-r border-gray-800 flex flex-col shadow-2xl z-[40] transition-transform duration-300 ease-in-out overflow-hidden ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
            {/* 헤더 영역 */}
