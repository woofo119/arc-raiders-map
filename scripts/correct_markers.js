...
// Marker Schema (Simplified for script)
...
async function main() {
    try {
        ...
        if (!adminUser) {
            console.error('Admin user not found. Please create an admin account first.');
            process.exit(1);
        }
        ...
        // Looking for: transform: translate3d(Xpx, Ypx, 0px) ... img src=".../ICON.png"
